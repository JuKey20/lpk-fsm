                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-xl-2 col-lg-2 mb-2">
                                    <a href="{{ route('master.leveluser.create') }}" class="mr-2 btn btn-primary w-100"
                                    ...
                                    <table class="table table-striped m-0">
                                        <thead>
                                            <tr class="tb-head">
                                                ...
                                                <th class="text-wrap align-top">Level User</th>
                                                <th class="text-wrap align-top">Informasi</th>
...
@section('js')
    <script>
        ...
        async function handleData(data) {
            let edit_button = `
            <a href='leveluser/edit/${data.id}' class="p-1 btn edit-data action_button"
                data-container="body" data-toggle="tooltip" data-placement="top"
            ...
            <a class="p-1 btn hapus-data action_button"
                data-container="body" data-toggle="tooltip" data-placement="top"
                title="Hapus ${title}: ${data.nama_level}"
                data-id='${data.id}'
            ...
            dataList.forEach((element, index) => {
                getDataTable += `
                    <tr class="text-dark">
                        ...
                        <td class="${classCol}">${element.informasi}</td>
                        <td class="${classCol}">
                            <div class="d-flex justify-content-center w-100">
                                <div class="hovering p-1">
                                    ${element.edit_button}
                                </div>
                                <div class="hovering p-1 mr-4">
